(function(exports, global) {
    ...
    function _aes_asm(stdlib, foreign, buffer) {
        ...
        function ecb_encrypt(offset, length) {
            ...
            while ((length | 0) >= 16) {
                _encrypt(HEAP[offset], HEAP[offset | 1], HEAP[offset | 2], HEAP[offset | 3], HEAP[offset | 4], HEAP[offset | 5], HEAP[offset | 6], HEAP[offset | 7], HEAP[offset | 8], HEAP[offset | 9], HEAP[offset | 10], HEAP[offset | 11], HEAP[offset | 12], HEAP[offset | 13], HEAP[offset | 14], HEAP[offset | 15]);
                HEAP[offset] = S0;
                HEAP[offset | 1] = S1;
                HEAP[offset | 2] = S2;
                HEAP[offset | 3] = S3;
